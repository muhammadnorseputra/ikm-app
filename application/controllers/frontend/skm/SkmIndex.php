...
class SkmIndex extends CI_Controller
{
    ...
    public function hitung($p,$j="")
    {
        ...
        endforeach;
            ...
            $presentase_predikat_konversi = ['SANGAT MUDAH' => number_format($presentase_a, 2), 
        ...
        // var_dump($konversi);
        $j = ['nilai_ikm' => $ikm, 'nilai_konversi' => $konversi, 'presentase' => @$presentase_predikat, 'presentase_konversi' => @$presentase_predikat_konversi];
        // var_dump($j);
        // echo json_encode($j);
        return $j;
    }
