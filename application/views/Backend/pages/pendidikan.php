...
<div class="row">
				...
				<div class="table-responsive">
					<table class="table">
						<thead class="thead-light">
							...
							<tbody class="list">
						<?php 
				            if(sub_privilege('sub_pendidikan', 'r') === false): 
				        ...
				        ?>
								...
								<tr>
									...
									<td>
									<?php 
							            if(sub_privilege('sub_pendidikan', 'u') === false): 
									...
									<td>
									<?php 
							            if(sub_privilege('sub_pendidikan', 'd') === false): 
	...
	<div class="col-xl-4">
		<div class="card">
			...
			<div class="card-body">
				<?php 
		            if(sub_privilege('sub_pendidikan', 'c') === false): 
		              $this->load->view('Backend/pages/notif_mod_dibatasi');
		            else:
		        ?>
